...
func ExampleLinearFold() {
	...
	result, score := LinearFold("UGAGUUCUCGAUCUCUAAAAUCG", CONTRAfoldv2)
...
func TestLinearFold(t *testing.T) {
	...
	result, score = LinearFold("AAAACGGUCCUUAUCAGGACCAAACA", CONTRAfoldv2)
	...
	result, score = LinearFold("AUUCUUGCUUCAACAGUGUUUGAACGGAAU", CONTRAfoldv2)
	...
	result, score = LinearFold("UCGGCCACAAACACACAAUCUACUGUUGGUCGA", CONTRAfoldv2)
	...
	result, score = LinearFold("GUUUUUAUCUUACACACGCUUGUGUAAGAUAGUUA", CONTRAfoldv2)
	...
	beam_size = 20
	result, score = LinearFold("GGGCUCGUAGAUCAGCGGUAGAUCGCUUCCUUCGCAAGGAAGCCCUGGGUUCAAAUCCCAGCGAGUCCACCA", CONTRAfoldv2)
