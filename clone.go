...
// a convenience wrapper around CutSequenceWithEnzyme that allows us to specify the enzyme by name.
func CutSequenceWithEnzymeByName(seq CloneSequence, enzymeStr string) ([]Fragment, error) {
