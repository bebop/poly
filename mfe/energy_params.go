...
var (
	// mismatchI37
	mismatchInteriorLoopEnergy37C = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatchIdH
	mismatchInteriorLoopEnthalpy = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatchH37
	mismatchHairpinLoopEnergy37C = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatchHdH
	mismatchHairpinLoopEnthalpy = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	/* mismatch_multi */
	// mismatchM37
	mismatchMultiLoopEnergy37C = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{ /* NP.. */
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatchMdH
	mismatchMultiLoopEnthalpy = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{ /* NP.. */
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatch1nI37
	mismatch1xnInteriorLoopEnergy37C = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatch1nIdH
	mismatch1xnInteriorLoopEnthalpy = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatch23I37
	mismatch2x3InteriorLoopEnergy37C = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatch23IdH
	mismatch2x3InteriorLoopEnthalpy = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	/* mismatch_exterior */
	// mismatchExt37
	mismatchExteriorLoopEnergy37C = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{ /* NP.. */
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	// mismatchExtdH
	mismatchExteriorLoopEnthalpy = [nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{ /* NP.. */
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
			{INF, INF, INF, INF, INF},
	...
	/* dangle5 */
	// dangle5_37
	dangle5Energy37C = [nbPairs + 1][nbNucleobase + 1]int{
		/*           N      A      C      G      U */
	...
	/* dangle3 */
	// dangle3_37
	dangle3Energy37C = [nbPairs + 1][nbNucleobase + 1]int{
		/*           N      A      C      G      U */
		/* NP */ {INF, INF, INF, INF, INF},
		/* CG */ {-40, -110, -40, -130, -60},
	...
	/* dangle5_enthalpies */
	// dangle5_dH
	dangle5Enthalpy = [nbPairs + 1][nbNucleobase + 1]int{
		/*           N      A      C      G      U */
		/* NP */ {INF, INF, INF, INF, INF},
	...
	/* dangle3_enthalpies */
	// dangle3_dH
	dangle3Enthalpy = [nbPairs + 1][nbNucleobase + 1]int{
		/*           N      A      C      G      U */
		/* NP */ {INF, INF, INF, INF, INF},
	...
	// ML_intern37
	multiLoopIntern37C int = -90
	// ML_interndH
	multiLoopInternEnthalpy int = -220
	// ML_closing37
	multiLoopClosing37C int = 930
	// ML_closingdH
	multiLoopClosingEnthalpy int = 3000
	// ML_BASE37
	...
	ninio37C int = 60
	// niniodH
	ninioEnthalpy int = 320
	// TerminalAU37
	terminalAU37C int = 50
	// TerminalAUdH
	terminalAUEnthalpy int = 370
	// INF is infinity as used in minimization routines (INT_MAX/10)
	INF int = 10000000
	// hairpin37
	hairpinLoopEnergy37C = [31]int{INF, INF, INF, 540, 560, 570, 540, 600, 550, 640, 650, 660, 670, 680, 690, 690, 700, 710, 710, 720, 720, 730, 730, 740, 740, 750, 750, 750, 760, 760, 770}
	// hairpindH
	hairpinLoopEnthalpy = [31]int{INF, INF, INF, 130, 480, 360, -290, 130, -290, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500}
	// bulge37
	bulgeEnergy37C = [31]int{INF, 380, 280, 320, 360, 400, 440, 460, 470, 480, 490, 500, 510, 520, 530, 540, 540, 550, 550, 560, 570, 570, 580, 580, 580, 590, 590, 600, 600, 600, 610}
	// bulgedH
	bulgeEnthalpy = [31]int{INF, 1060, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710, 710}
	// internal_loop37
	interiorLoopEnergy37C = [31]int{INF, INF, 100, 100, 110, 200, 200, 210, 230, 240, 250, 260, 270, 280, 290, 290, 300, 310, 310, 320, 330, 330, 340, 340, 350, 350, 350, 360, 360, 370, 370}
	// internal_loopdH
	interiorLoopEnthalpy = [31]int{INF, INF, -720, -720, -720, -680, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130, -130}

	// stack37
	stackingPairEnergy37C = [nbPairs + 1][nbPairs + 1]int{
	...
	// stackdH
	stackingPairEnthalpy = [nbPairs + 1][nbPairs + 1]int{
		{INF, INF, INF, INF, INF, INF, INF, INF},
	...
	// Tetraloop37
	tetraLoopEnergy37C = map[string]int{"CAACGG": 550, "CCAAGG": 330, "CCACGG": 370, "CCCAGG": 340,
	...
	// TetraloopdH
	tetraLoopEnthalpy = map[string]int{"CAACGG": 690, "CCAAGG": -1030, "CCACGG": -330, "CCCAGG": -890,
	...
	// Triloop37
	triLoopEnergy37C = map[string]int{"CAACG": 680, "GUUAC": 690}
	// TriloopdH
	triLoopEnthalpy = map[string]int{"CAACG": 2370, "GUUAC": 1080}

	// Hexaloops
	hexaLoops = map[string]bool{"ACAGUACU": true, "ACAGUGAU": true, "ACAGUGCU": true, "ACAGUGUU": true}
	// Hexaloop37
	hexaLoopEnergy37C = map[string]int{"ACAGUACU": 280, "ACAGUGAU": 360, "ACAGUGCU": 290, "ACAGUGUU": 180}
	// HexaloopdH
	hexaLoopEnthalpy = map[string]int{"ACAGUACU": -1680, "ACAGUGAU": -1140, "ACAGUGCU": -1280, "ACAGUGUU": -1540}

	// int11_37
	interior1x1LoopEnergy37C = [nbPairs + 1][nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{
				{INF, INF, INF, INF, INF},
				{INF, INF, INF, INF, INF},
	...
	// int21_37
	interior2x1LoopEnergy37 = [nbPairs + 1][nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{
				{
					{INF, INF, INF, INF, INF},
	...
	// int21_dH
	interior2x1LoopEnthalpy = [nbPairs + 1][nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{
				{
					{INF, INF, INF, INF, INF},
	...
	// int22_dH
	interior2x2LoopEnthalpy = [nbPairs + 1][nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{
				{
					{
	...
	// int22_37
	interior2x2LoopEnergy37 = [nbPairs + 1][nbPairs + 1][nbNucleobase + 1][nbNucleobase + 1][nbNucleobase + 1][nbNucleobase + 1]int{
		{
			{
				{
					{
