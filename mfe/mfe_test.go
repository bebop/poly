...
func ExampleMinimumFreeEnergy() {
	mfe, energyContributions, _ := MinimumFreeEnergy("ACGAUCAGAGAUCAGAGCAUACGACAGCAG", "..((((...))))...((........))..", 4)
	fmt.Println(mfe)
	logEnergyContributions(energyContributions, "ACGAUCAGAGAUCAGAGCAUACGACAGCAG")
	// Output:
	// -10.49
}
...
func compareMFEOutputToViennaRNA(sequence, structure string, expected_output string, t *testing.T) {
